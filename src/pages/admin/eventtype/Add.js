...
const Dashboard = ({ title }) => {
    ...
    const HandelForm = async () => {
        try {
            ...
            fetch(apiurl + 'category/create-event-type', {
                method: 'POST',
                headers: {
                                    ...
                                    <Row className="justify-content-center">
                                        <Col md={4}>
                                            <div>
                                                ...
                                                <input type="text" class="form-control input-default" placeholder="Enter name" value={Categoryname} onChange={(e) => setCategoryname(e.target.value)} />
                                            </div>
                                            <div>
                                                {Loader ? (
                                                    ...
                                                    <Button variant="link" onClick={HandelForm} className="button-join" type="button">
                                                        <span>
                                                            <span className="bg-style"><img height={30} width={30} src={whitestar} /></span><span className="bg-style bg-title-style">Add</span>
                                                        </span>
                                                    </Button>
                                                )}
